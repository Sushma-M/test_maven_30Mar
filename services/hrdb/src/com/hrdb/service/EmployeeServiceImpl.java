...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    private WMGenericDao<Employee, Float> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Employee, Float> wmGenericDao) {
	...
	@Override
	public Employee getById(Float employeeId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Employee findById(Float employeeId) {
        LOGGER.debug("Finding Employee by id: {}", employeeId);
	...
	public Employee update(Employee employee) throws EntityNotFoundException {
        ...
        Float employeeId = employee.getEmpId();
    ...
    @Transactional(value = "hrdbTransactionManager")
	@Override
	public Employee delete(Float employeeId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Employee> findAssociatedEmployeesForManagerId(Float empId, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Vacation> findAssociatedVacations(Float empId, Pageable pageable) {
