...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    private WMGenericDao<Department, Float> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Department, Float> wmGenericDao) {
	...
	@Override
	public Department getById(Float departmentId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Department findById(Float departmentId) {
        LOGGER.debug("Finding Department by id: {}", departmentId);
	...
	public Department update(Department department) throws EntityNotFoundException {
        ...
        Float departmentId = department.getDeptId();
    ...
    @Transactional(value = "hrdbTransactionManager")
	@Override
	public Department delete(Float departmentId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Employee> findAssociatedEmployees(Float deptId, Pageable pageable) {
