...
public interface UserService {
	 ...
	 */
	User getById(Float userIdInstance) throws EntityNotFoundException;
	 ...
	 * @return User associated with the given userIdInstance.
	 */
	User findById(Float userIdInstance);
	 ...
	 */
	User delete(Float userIdInstance) throws EntityNotFoundException;
