...
public class VacationServiceImpl implements VacationService {
    ...
    private WMGenericDao<Vacation, Float> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Vacation, Float> wmGenericDao) {
	...
	@Override
	public Vacation getById(Float vacationId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public Vacation findById(Float vacationId) {
        LOGGER.debug("Finding Vacation by id: {}", vacationId);
	...
	public Vacation update(Vacation vacation) throws EntityNotFoundException {
        ...
        Float vacationId = vacation.getId();
    ...
    @Transactional(value = "hrdbTransactionManager")
	@Override
	public Vacation delete(Float vacationId) throws EntityNotFoundException {
