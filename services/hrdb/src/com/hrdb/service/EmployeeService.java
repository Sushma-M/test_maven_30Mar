...
public interface EmployeeService {
	 ...
	 */
	Employee getById(Float employeeId) throws EntityNotFoundException;
	 ...
	 * @return Employee associated with the given employeeId.
	 */
	Employee findById(Float employeeId);
	 ...
	 */
	Employee delete(Float employeeId) throws EntityNotFoundException;
     ...
     * @see Page
     */
    Page<Employee> findAssociatedEmployeesForManagerId(Float empId, Pageable pageable);
     ...
     * @see Page
     */
    Page<Vacation> findAssociatedVacations(Float empId, Pageable pageable);
