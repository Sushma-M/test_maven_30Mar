...
public class UserServiceImpl implements UserService {
    ...
    private WMGenericDao<User, Float> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<User, Float> wmGenericDao) {
	...
	@Override
	public User getById(Float userIdInstance) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
	@Override
	public User findById(Float userIdInstance) {
        LOGGER.debug("Finding User by id: {}", userIdInstance);
	...
	public User update(User user) throws EntityNotFoundException {
        ...
        Float userIdInstance = user.getUserId();
    ...
    @Transactional(value = "hrdbTransactionManager")
	@Override
	public User delete(Float userIdInstance) throws EntityNotFoundException {
