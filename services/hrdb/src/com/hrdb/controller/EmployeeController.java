...
public class EmployeeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getEmployee(@PathVariable("id") Float id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee editEmployee(@PathVariable("id") Float id, @RequestBody Employee employee) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployee(@PathVariable("id") Float id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employee> findAssociatedEmployeesForManagerId(@PathVariable("id") Float id, Pageable pageable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Vacation> findAssociatedVacations(@PathVariable("id") Float id, Pageable pageable) {
